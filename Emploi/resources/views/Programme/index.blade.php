            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a type="submit" class="btn btn-secondary" href=" {{ Route('Programme.edit', ['id' => $programme->id]) }} ">Modifier</a> &nbsp &nbsp
                  <a type="submit" class="btn btn-danger"  href=" {{ Route('Programme.destroy', ['id' => $programme->id]) }} ">Supprimer</a></td>
              </tr>
              @endforeach
            </tbody>
          </table>
